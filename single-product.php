                                                        ...
                                                        <div class="swiper-wrapper h-100">
                                                            <?php foreach ($product_gallery_ids as $product_gallery) { ?>
                                                                <div class="swiper-slide h-100 swiper-slide-active bg-white rounded">
                                                                    <a href="<?= wp_get_attachment_image_url($product_gallery, 'large') ?>" data-fancybox="gallery-1" class="d-block image-box image-style h-100">
                                        ...
                                        <div class="inner-box-style p-0 rounded">
                                            <div class="row g-0">
                                                <?php foreach ($variations as $variation) { ?>
                                                    ...
                                                    $layout = $attributes['attribute_layout'];
                                                    $attribute_pa_berths = $attributes['attribute_pa_berths'];

                                                    ?>
                                                    <div class="col-md-6">
                                                        <div class="layouts--inner">
                                                            <div class="listing-grid__image image-style" style="--fit: contain">
                                                                <?= wp_get_attachment_image($variation_obj->get_image_id(), 'large') ?>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <h3 class="fs-24"><?= $layout ?></h3>
                                                                    <div class="price">
                                                                        <?= $variation_obj->get_price_html() ?>
                                                                    </div>
                                                                </div>
