...
function custom_listing_template()
{
    ...
    $listing_template .= "\t\t" . '<div class="d-flex gap-3 align-items-lg-center justify-content-between flex-column flex-lg-row ">' . "\r\n";
    ...
    $listing_template .= "\t\t\t" . '<div class="wpsl-contact-details fs-14 mb-0">' . "\r\n";
