            ...
            <div class="hero-title-image md-margin-top">
                <div class="row">
                    <div class="col-12 md-padding-bottom">
                        ...
                        <ul class="blog-meta d-flex gap-4 list-inline align-items-center flex-wrap">
                                ...
                                <div class="row g-5">
                                    <div class="col-12 d-flex flex-column justify-content-between text-center">
                                        <div class="share mb-5">
                                            ...
                                            <div class="socials d-inline-flex gap-3 list-inline mb-0 align-items-center">
